...
- requirement \n i need to create an mcp tool for copy_sheet(uri) and return a new copy sheet uri and list of worksheet , new sheet should rename as copy-of-{ORIGINAL_SHEET_NAME} , it will read all the worksheet and write_new_sheet and then write_new_worksheet, if you think there is a better method to do so , please provide. \n # rule: \n 1) you need to see how other tool is implement , and then follow the same pattern. \n 2) write new test case , follow the patter of tests/test_mcp_client_calltool.py  for case copy \n 3) if anything unclear, ask question. give a plan how to do so , wait for my confirmation before apply code change.
- requirement \n i need to create an mcp tool for copy_sheet(uri) and return a new copy sheet uri and list of worksheet , new sheet should rename as copy-of-{ORIGINAL_SHEET_NAME} , it will read all the worksheet and write_new_sheet and then write_new_worksheet, if you think there is a better method to do so , please provide. \n # rule: \n 1) you need to see how other tool is implement , and then follow the same pattern. \n 2) write new test case , follow the patter of tests/test_mcp_client_calltool.py  for case copy \n 3) if anything unclear, ask question. give a plan how to do so , wait for my confirmation before apply code change.
