...
async def write_new_sheet(
    ctx: Context,
    data: list[list[int| str |float| bool | dict[str, Any] | None]] = Field(description="Data Accepts: List[List[int| str |float| bool | dict[str, Any] | None]] (2D array)"),
    ...
    Args:
        data: Data in pandas-like formats. Accepts:
              - List[List[int| str |float| bool | dict[str, Any] | None]]: 2D array of table data (rows x columns)
